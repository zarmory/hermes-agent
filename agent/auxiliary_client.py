...
def resolve_provider_client(
    ...
    if pconfig is None:
        ...
        # whose main provider is a non-api_key one. This bug landed the
        # moment ``provider: gemini`` migrated to ``provider: vertex`` on
        # 2026-07-07 and stayed silent because the aggregator fallbacks
        # (openrouter/nous) usually had credentials.
        #
